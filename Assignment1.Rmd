...
# length(unique(df[,8]))#duplicates in gene names ask later
# rowNames <- (df[,8])
# rownames(expression_df)<- rowNames
# 
# rm(df)
...
deseq_df <- deseq_results %>%
 ...
 plotCounts(ddset, gene = "ENSG00000000003|X|99883667|99894988|-|11322|2968|TSPAN6|protein_coding", intgroup = "X.Sample_characteristics_ch1.4")
