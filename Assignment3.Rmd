...
k5_10 <- kmeans(V10, centers = 5)
k6_10 <- kmeans(V10, centers = 6)
...
k5_100 <- kmeans(V100, centers = 5)
k6_100 <- kmeans(V100, centers = 6)

fviz_cluster(k3, V100)
fviz_cluster(k4, V100)
fviz_cluster(k5, V100)
fviz_cluster(k6, V100)
...
k5_1000 <- kmeans(V1000, centers = 5)
k6_1000 <- kmeans(V1000, centers = 6)

fviz_cluster(k3, V1000)
fviz_cluster(k4, V1000)
fviz_cluster(k5, V1000)
fviz_cluster(k6, V1000)
...
k5_10000 <- kmeans(V10000, centers = 5)
k6_10000 <- kmeans(V10000, centers = 6)

fviz_cluster(k3, V10000)
fviz_cluster(k4, V10000)
fviz_cluster(k5, V10000)
fviz_cluster(k6, V10000)
